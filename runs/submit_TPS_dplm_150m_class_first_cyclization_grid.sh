...
#
# Syntax:
#   [VAR=value ...] bash runs/dplm/submit_TPS_dplm_150m_class_first_cyclization_grid.sh
#
# Examples:
#   DRY_RUN=1 bash runs/dplm/submit_TPS_dplm_150m_class_first_cyclization_grid.sh
#   CLUSTER=karolina DRY_RUN=1 bash runs/dplm/submit_TPS_dplm_150m_class_first_cyclization_grid.sh
#   CLUSTER=karolina SCHEDULER_TYPE=slurm bash runs/dplm/submit_TPS_dplm_150m_class_first_cyclization_grid.sh
#
...
submit_job() {
    ...
    job_name="fcl${lr_code}w${warmup_code}i${warmup_init_code}${lora_code}"
