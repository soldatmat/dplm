...
# Usage:
#   bash runs/dplm/submit_TPS_dplm_150m_class_mini_first_cyclization_grid.sh
#
# Optional environment overrides:
#   DATADIR=<path> RUN_PREFIX=<prefix> DRY_RUN=1 bash runs/dplm/submit_TPS_dplm_150m_class_mini_first_cyclization_grid.sh

DATADIR="${DATADIR:-/storage/brno2/home/soldatmat/documents/terpene_synthases/dplm}"
EXP="tps/TPS_dplm_150m_class_mini_first_cyclization"
