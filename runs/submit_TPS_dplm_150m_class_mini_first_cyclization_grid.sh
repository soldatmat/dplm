...
#
# Syntax:
#   [VAR=value ...] bash runs/submit_TPS_dplm_150m_class_mini_first_cyclization_grid.sh
#
# Examples:
#   DRY_RUN=1 bash runs/submit_TPS_dplm_150m_class_mini_first_cyclization_grid.sh
#   CLUSTER=karolina DRY_RUN=1 bash runs/submit_TPS_dplm_150m_class_mini_first_cyclization_grid.sh
#   CLUSTER=karolina SCHEDULER_TYPE=slurm bash runs/submit_TPS_dplm_150m_class_mini_first_cyclization_grid.sh
#
...
submit_job() {
    ...
    job_name="cml${lr_code}w${warmup_code}t${total_code}s${save_code}v${val_code}e${lr_end_code}i${warmup_init_code}${lora_code}m${ltm_idx}"
