...
from byprot.models.dplm.modules.class_encoder import ClassEncoderConfig, ClassEncoder


@dataclass
class DPLMClassConfig:
    encoder: ClassEncoderConfig = field(default=ClassEncoderConfig())
    decoder: DPLMWithGlobalAdapterConfig = field(default=DPLMWithGlobalAdapterConfig())
    init_pred_where: bool = True


@register_model("dplm_class")
class DPLMClass(nn.Module):
    _default_cfg = DPLMClassConfig()
